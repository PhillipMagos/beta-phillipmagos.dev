...
//import { fa-brands fa-linkedin } from '@fortawesome/free-brands-svg-icons';
    ...
    <nav className="bg-top flex justify-between bg-gray-900 text-white w-screen">
      <div className="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          ...
          <li><a className="hover:text-gray-200" href="/about">About</a></li>
          <li><a className="hover:text-gray-200" href="/contact">Contact</a></li>
          <li><a className="hover:text-gray-200" href="/developments">Developments</a></li>
        </ul>
        {/* <!-- Header Icons --> */}
        <div className="hidden xl:flex items-center space-x-5 items-center">
          <a className="hover:text-gray-200" href="https://google.com">
