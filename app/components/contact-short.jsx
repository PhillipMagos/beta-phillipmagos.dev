    ...
    return (
        ...
        <label for="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-900">Send Resume</label>
                    ...
                    <button
                        ...
                        type="submit"
                        className="max-w-2xl text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit
                    </button>
