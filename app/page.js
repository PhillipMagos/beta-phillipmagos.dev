    ...
    <div>
      ...
      <section className="bg-center bg-no-repeat bg-blend-multiply">
        <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
          ...
          <p className="mb-2 text-lg font-normal text-gray-700 2xl:text-white lg:text-xl sm:px-16 lg:px-48">I develop websites that are responsive to numerous devices....</p>
          <p className="mb-2 text-lg font-normal text-gray-700 lg:text-white lg:text-xl sm:px-16 lg:px-48">Responsive to laptop screens...</p>
          <p className="mb-2 text-lg font-normal text-gray-700 md:text-white lg:text-xl sm:px-16 lg:px-48">To the sizes of tablets..</p>
